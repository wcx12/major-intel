...
# as a direct CLI script.  Direct execution puts this directory on `sys.path`,
# so we add `src/` before importing package modules.
...
from major_intel.function_calls.retrieval_tools import RetrievalTools, tool_result
